...
alias cp="cp -vi" #Copy with prompt and verbosity
alias mv="mv -vi" #Move with prompt and verbosity
...
alias zdup="flatpak --user update -y && sudo zypper dup" #Update OpenSuse Tumbleweed and Flatpak
